...
public class Core extends AbstractCore {
    ...
    protected boolean createCommands() {
        ...
        this.cmdList = new CommandList(
                new BuyCraftCommand    ("/buycraft", "", "buycraft.aliases",
                            new AddAliasCommand         ("addAlias",    "<PlayerName> <AliasName>", "buycraft.aliases", this.shopManager),
                            new RemoveAliasCommand      ("delAlias",    "<Name>",                   "buycraft.aliases", this.shopManager),
                            new ListAllAliasesCommand   ("listAlias",   "",                         "buycraft.aliases", this.shopManager)
                        )
         );
        // @formatter: on;
        return true;
